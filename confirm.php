            ...
            <div class="row my-auto">
                <div class="col-10 col-md-8 offset-1 offset-md-2 text-left">                    
                    ...
                    <div class="text-center">
                        <span class="far fa-thumbs-up display-4 text-secondary my-4"></span>
                    </div>
                    <p class="initialism text-center">
                        Herzliche Glückwünsche. Ihre Nachricht wurde erfolgreich registriert! 
                        Bitte denken Sie jedoch daran, dass dies nur eine Demonstration einer 
                        echten Website ist. Aus diesem Grund wird Ihre Nachricht nicht 
